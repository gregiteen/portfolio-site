...
accent: "#BC0000"
style: "A maximalist, experimental interface inspired by 1980s Swiss poster design and punk zines. The palette is a jarring mix of deep blood red, stark black, and pure white. The typography uses a massively bold, extended sans-serif set entirely in lowercase, breaking across lines arbitrarily without hyphens. The layout completely ignores standard web conventions, using rotated text, extreme negative space, and chaotic margins."
---
